...
<h1>Konak Hotel Booking Website</h1>
<h:form id ="form11">
		<table>
		<tr>
		...
		<h:form id="form15">
		<h:commandLink action="#{userReview.displayreview}">Hotel Reviews</h:commandLink>
		</h:form>
		<h:outputLink value="AdminLogin.jsp">Admin Login</h:outputLink><br>
		<h:outputLink value="Contactus.jsp">Contact Us</h:outputLink><br>
		<h:outputLink value="Registration.jsp">New User Registration</h:outputLink><br>
		<h:outputLink value="Login.jsp">User Login</h:outputLink><br>
		<h:outputLink value="Forgot.jsp">Forgot Password</h:outputLink><br>
</f:view>
</body>
</html>